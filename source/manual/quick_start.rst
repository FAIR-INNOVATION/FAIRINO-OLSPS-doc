...
.. centered:: 图2-27  标定板放置位置

.. figure:: quick_start/25.png
	:align: center
	:width: 4in

.. centered:: 图2-28  AIRLab软件-相机显示
...
5) 本轮相机标定结束后，可以更改标定板位置，再次点击“自动运行”按钮进行下一轮标定，该步骤目的是为了提高系统精度，可以选择标定3~5轮，系统会选择其中精度最高的坐标系使用；
6) 3~5轮标定结束后点击“标定结束”按钮，完成相机手眼标定；
