...
.. centered:: 图3-52  获取slam子地图1

.. figure:: analysis/slam5.png
	:align: center
	:width: 6in

.. centered:: 图3-53  获取slam子地图2
...
.. centered:: 图3-61  添加模型构建节点

.. important::
	注意：如果工件为对称性工件，在添加模型构建节点时需开启完整性判断；如图所示。同时在构建模型时需要将整个工件都拍摄完整。

.. figure:: analysis/Integrity_Test.png
	:align: center
	:width: 2.5in

.. centered:: 图3-62  开启完整性判断
...
.. centered:: 图3-87  AIRLab版本信息和发布日期显示
...
.. centered:: 图3-90  选择AIRLab.tar.gz升级包
...
.. centered:: 图3-94  AIRLab软件升级失败及回滚
...
.. centered:: 图3-104  开启碰撞检测规划的自动避障路径

.. figure:: analysis/86.png
	:align: center
	:width: 4in

.. centered:: 图3-105  不开启碰撞检测规划的空移路径
...
.. centered:: 图3-117  达到清枪剪丝周期，AIRLab询问弹窗
...
.. centered:: 图3-118  自动模式下未设置周期的提示弹窗
...
.. centered:: 图3-119  AIRLab菜单栏-窗口-自动循环运行
...
.. centered:: 图3-121  工件正在识别中

.. figure:: analysis/102.png
	:align: center
	:width: 6in

.. centered:: 图3-122   工件识别成功，匹配度为82%

.. figure:: analysis/103.png
	:align: center
	:width: 6in

.. centered:: 图3-123  自动检索焊接工程后导入新工程

.. figure:: analysis/104.png
	:align: center
	:width: 6in

.. centered:: 图3-124  工件识别失败提示信息
...
.. centered:: 图3-125   一次循环运行结束，正在等待循环间隔
...
.. centered:: 图3-126  达到设置的循环次数，结束自动循环运行
...
.. centered:: 图3-128  用户数据正在打包导出中

.. figure:: analysis/109.png
	:align: center
	:width: 6in

.. centered:: 图3-129  用户数据导出完成
...
.. centered:: 图3-130  单个模板数据的目录结构

.. figure:: analysis/110.png
	:align: center
	:width: 2in

.. centered:: 图3-131  全部数据包的目录结构
...
.. centered:: 图3-132  选择待导入的数据包

.. figure:: analysis/112.png
	:align: center
	:width: 6in

.. centered:: 图3-133  数据包正在导入中

.. figure:: analysis/113.png
	:align: center
	:width: 6in

.. centered:: 图3-134  数据包导入完成

.. figure:: analysis/114.png
	:align: center
	:width: 6in

.. centered:: 图3-135  数据包无法导入提示
...
.. centered:: 图3-154 “多语言设置”页面

上述功能的详细操作介绍如下：

1. 切换AIRLab的语言

点击图3-154中“多语言选择”的下拉框，选择需要的语言类型后点击“确定”按钮即可立即切换AIRLab软件语言。

2. 用户为AIRLab设置新语言
   
首先点击“导出”按钮，导出AIRLab当前使用的语言文件，该文件为CSV格式，导出的文件路径在本地的Downloads文件夹下，如图3-155。

.. figure:: analysis/125.png
	:align: center
	:width: 5in

.. centered:: 图3-155 AIRLab语言文件导出路径
...
.. centered:: 图3-156 AIRLab语言CSV文件的内容及格式

如果使用LibreOfffice软件打开，如图3-157，注意打开格式如下图3-158所示。

.. figure:: analysis/127.png
	:align: center
	:width: 2.5in

.. centered:: 图3-157  LibreOffice软件

.. figure:: analysis/128.png
	:align: center
	:width: 6in

.. centered:: 图3-158  AIRLab多语言文件的打开格式
...
.. centered:: 图3-159  “导入”按钮的弹窗

.. figure:: analysis/130.png
	:align: center
	:width: 3in

.. centered:: 图3-160 语言文件导入成功时的终端显示信息
...
.. centered:: 图3-161  语言文件导入失败时的日志信息提示
...
.. centered:: 图3-165  扩展轴坐标系标定界面（左）与弹窗提示（右）
