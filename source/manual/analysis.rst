...
菜单栏
--------------------------
菜单栏包含的所有内容如图4-2所示，主要有按钮：“文件”、“视图”、“窗口”、“工艺”、“仿真”、“插件”，以及图标按钮（从左到右顺序）：点位新增、坐标系新增、模式切换、暂停运行、开始运行、停止运行、视野移动、视野旋转。
...
窗口
~~~~~~~~~~~~~~~~~~~
“窗口”包含9个二级选项，分别是“软件升级”、“焊接数据采集”、“关于”、“日志”、“虚拟相机”、“全局设置”、“清枪剪丝”、“自动循环运行”、“用户数据备份”。点击不同的选项，AIRLab出现不同的功能弹窗。详细功能和用法说明见4.6节中的弹窗介绍。
...
“工艺”包括“焊接工艺”、“圆柱填充”，根据工艺需要选择不同的工艺，单击选项出现对应的功能弹窗。详细介绍见4.6工程模块解析章节介绍。

.. figure:: analysis/9.png
	:align: center
	:width: 2.5in

.. centered:: 图4-9  AIRLab菜单栏-工艺
...
.. centered:: 图4-12 AIRLab菜单栏-点位新增

.. figure:: analysis/13.png
	:align: center
	:width: 3in

.. centered:: 图4-13  AIRLab终端-点位新增成功信息打印
...
.. centered:: 图4-14  AIRLab菜单栏-参考坐标系
...
.. centered:: 图4-15  AIRLab菜单栏-参考坐标系-编辑坐标系

可以选择参考坐标系的参考坐标系是工件坐标系、基座标系或世界坐标系，设置坐标系的位置，选择是否显示该参考坐标系。图4-16为显示坐标系，图4-17为不显示坐标系。

.. figure:: analysis/16.png
	:align: center
	:width: 3in

.. centered:: 图4-16  AIRLab菜单栏-参考坐标系-显示坐标系
...
.. centered:: 图4-17  AIRLab菜单栏-参考坐标系-不显示坐标系
...
.. centered:: 图4-19  视野旋转弹窗

主显示框
--------------------------

主显示框分为场景显示和相机显示，其中场景主要显示机器人、工具、工件、扩展轴模型等，如图4-20。相机主要显示获得的点云图，如图4-21。

.. figure:: analysis/20.png
	:align: center
	:width: 6in

.. centered:: 图4-20  AIRLab主显示框-场景显示

.. figure:: analysis/21.png
	:align: center
	:width: 6in

.. centered:: 图4-21 AIRLab主显示框-相机显示
...
.. centered:: 图4-23  AIRLab操作区-笛卡尔空间移动
...
.. centered:: 图4-25  AIRLab操作区-关节空间空间移动
...
.. centered:: 图4-26  AIRLab操作区-移动扩展轴位置
...
无模型构建模块
~~~~~~~~~~~~~~~~~~~
如果要焊接的工件没有模型文件，则需要先对工件进行无模型构建，否则直接导入工件模型进行4.5.3焊缝编辑操作即可。点击工程模块-模型构建；

.. figure:: analysis/44.png
	:align: center
	:width: 6in

.. centered:: 图4-44  工程模块-模型构建
...
关于
~~~~~~~~~~~~~~~~~~~
选中“关于”，点击该按钮会查询到当前AIRLab软件、中间层和视觉的版本信息和发布日期，如图4-70所示。

.. figure:: analysis/70.png
	:align: center
	:width: 3in

.. centered:: 图4-70  AIRLab版本信息和发布日期显示

日志
~~~~~~~~~~~~~~~~~~~
日志用于记录系统的运行过程及异常信息，可以快速定位问题。点击该按钮会出现一个“日志等级”弹窗。日志记录分为4个等级，分别是INFO、WARNING、ERROR、DEBUG，选择日志等级后设置当前日志等级（默认INFO）。如图4-71所示，具体含义见表4-2。

.. figure:: analysis/71.png
	:align: center
	:width: 2.5in

.. centered:: 图4-71  AIRLab菜单栏-日志
...
.. centered:: 图4-73  选择AIRLab.tar.gz升级包
...
.. centered:: 图4-77  AIRLab软件升级失败界面反馈
...
.. centered:: 图4-85  开启碰撞检测规划的自动避障路径

.. figure:: analysis/86.png
	:align: center
	:width: 4in

.. centered:: 图4-86  不开启碰撞检测规划的空移路径
...
.. centered:: 图4-97  达到清枪剪丝周期，AIRLab询问弹窗
...
.. centered:: 图4-98  自动模式下未设置周期的提示弹窗
...
.. centered:: 图4-99  AIRLab菜单栏-窗口-自动循环运行
...
.. centered:: 图4-101  工件正在识别中

.. figure:: analysis/102.png
	:align: center
	:width: 6in

.. centered:: 图102  工件识别成功，匹配度为82%

.. figure:: analysis/103.png
	:align: center
	:width: 6in

.. centered:: 图4-103  自动检索焊接工程后导入新工程

.. figure:: analysis/104.png
	:align: center
	:width: 6in

.. centered:: 图4-104  工件识别失败提示信息
...
.. centered:: 图4-105   一次循环运行结束，正在等待循环间隔
...
.. centered:: 图4-106  达到设置的循环次数，结束自动循环运行
...
.. centered:: 图4-108  用户数据正在打包导出中

.. figure:: analysis/109.png
	:align: center
	:width: 6in

.. centered:: 图4-109  用户数据导出完成
...
.. centered:: 图4-110  数据包的目录结构

导入功能：点击“选择文件”按钮，选择需要导入的数据包（要导入的数据包目录请与图4-110中的结构保持一致），然后点击“导入”按钮，AIRLab首先会校验导入数据包中的version.txt中的版本号，如果版本号一致则会开始数据包内容的导入；如果版本号不匹配，会给出弹窗信息提示用户版本号不一致，数据会不兼容无法进行导入。

.. figure:: analysis/111.png
	:align: center
	:width: 6in

.. centered:: 图4-111  选择待导入的数据包

.. figure:: analysis/112.png
	:align: center
	:width: 6in

.. centered:: 图4-112  数据包正在导入中

.. figure:: analysis/113.png
	:align: center
	:width: 6in

.. centered:: 图4-113  数据包导入完成

.. figure:: analysis/114.png
	:align: center
	:width: 6in

.. centered:: 图4-114  数据包无法导入提示
...
.. centered:: 图4-116  长直焊缝编辑时需要设置扩展轴位置参数
...
.. centered:: 图4-125 AIRLab语言文件导出路径
...
.. centered:: 图4-126 AIRLab语言CSV文件的内容及格式
...
.. centered:: 图4-127  LibreOffice软件

.. figure:: analysis/128.png
	:align: center
	:width: 6in

.. centered:: 图4-128  AIRLab多语言文件的打开格式
...
.. centered:: 图4-129  “导入”按钮的弹窗

.. figure:: analysis/130.png
	:align: center
	:width: 3in

.. centered:: 图4-130 语言文件导入成功时的终端显示信息
...
.. centered:: 图4-131  语言文件导入失败时的日志信息提示
