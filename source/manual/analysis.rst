...
窗口
~~~~~~~~~~~~~~~~~~~
“窗口”包含5个二级选项，分别是“软件升级”、“关于”、“版本校验”、“日志”、“虚拟相机”。点击不同的选项，AIRLab出现不同的功能弹窗。详细功能和用法说明见3.6节中的弹窗介绍。
...
首先打开“SLAM建图拍照设置”界面，如果选择模式为摆动扫描，则按照如下图进行扫描方式设置。
...
在该模式下，程序由多组包含起点、终点和过渡点的移动指令组成；原则是要将箱体模型拍摄完整；所有的移动节点添加完成后，添加SLAM建图节点，程序完成结构如下图所示。
...
圆柱填充工艺查询弹窗
~~~~~~~~~~~~~~~~~~~~~~~~~~
点击菜单栏工艺-圆柱填充，AIRLab界面显示圆柱填充工艺查询弹窗。图3-125所示为圆柱填充工艺查询的弹窗，圆柱填充工艺包括圆柱底面填充和二次加固两个部分。
